...
var P2PCommunicationClient = /** @class */ (function (_super) {
    ...
    P2PCommunicationClient.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            var relayServer, client, loginString, _a, _b, _c, _d, loginRawDigest, rawSignature, _e, _f, _g, error_2;
            var _h;
            var _this = this;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        loginString = "login:" + Math.floor(Date.now() / 1000 / (5 * 60));
                        _b = (_a = logger).log;
                        _c = ['start'];
                        _d = "login " + loginString + ", ";
                        return [4 /*yield*/, this.getPublicKeyHash()];
                    case 3:
                        _b.apply(_a, _c.concat([_d + (_j.sent()) + " on " + relayServer]));
                        loginRawDigest = (0, libsodium_wrappers_1.crypto_generichash)(32, (0, libsodium_wrappers_1.from_string)(loginString));
                    ...
                    case 5:
                        _h.id = _j.sent();
                        _g = "ed:" + (0, beacon_utils_1.toHex)(rawSignature) + ":";
                        return [4 /*yield*/, this.getPublicKey()];
                    case 6: return [4 /*yield*/, _f.apply(_e, [(_h.password = _g + (_j.sent()),
                                _h.deviceId = (0, beacon_utils_1.toHex)(this.keyPair.publicKey),
                                _h)])];
                    case 7:
                        _j.sent();
                        return [3 /*break*/, 10];
                    ...
                    case 9:
                        _j.sent(); // If we can't log in, let's reset
